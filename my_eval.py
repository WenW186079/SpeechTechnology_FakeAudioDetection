...
def evaluate_nn(
    ...
    ################################################################
    data_val = MyDataset(
        real_metafile_name="/mount/arbeitsdaten/deepfake/SpeechTechnology2023/ww/deepfake-whisper-features/meta_path/pl_real_test.csv",
        spoof_metafile_name="/mount/arbeitsdaten/deepfake/SpeechTechnology2023/ww/deepfake-whisper-features/meta_path/pl_vits_test.csv",
    )
...
def main():
    ...
    #config_path = "model__rawnet3__1711981315.3284469.yaml"        #rawnet3 - en/gl
    #config_path = "model__rawnet3__1711982401.4415708.yaml"        #rawnet3 - de/gl
    #config_path = "model__rawnet3__1711981012.7818565.yaml"        #rawnet3 - uk/gl

    #config_path = "model__rawnet3__1711981631.6480997.yaml"        #rawnet3 - en/vits
    #config_path = "model__rawnet3__1711982011.8915806.yaml"        #rawnet3 - de/vits
    #config_path = "model__rawnet3__1711980734.336461.yaml"         #rawnet3 - uk/vits


    #config_path = "model__specrnet__1711979909.836801.yaml"        #specrnet - en/griffin_lim
    #config_path = "model__specrnet__1711980338.6448445.yaml"       #specrnet - de/griffin_lim
    #config_path = "model__specrnet__1711980456.801027.yaml"        #specrnet - uk/griffin_lim

    #config_path = "model__specrnet__1711980090.7782454.yaml"        #specrnet - en/vits
    #config_path = "model__specrnet__1711980198.1790054.yaml"        #specrnet - de/vits
    config_path = "model__specrnet__1711980607.0468488.yaml"        #specrnet - uk/vits
