...
class MyDataset(SimpleAudioFakeDataset):
    ...
    def read_samples(self):
        ...
        real_samples["path"] = real_samples["file"].apply(lambda n: str(real_path / n))
        ...
        # Combine real and spoof samples
...
if __name__ == "__main__":
    train_dataset = MyDataset(
        ...
        spoof_path= "/mount/resources/speech/corpora/MLAAD/fake/en/griffin_lim",
